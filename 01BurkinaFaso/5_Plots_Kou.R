...
# remove unnecessary data and values
# remove unncessary data and values
rm(i, input.datasets)
rm(d.trees.4_10, d.wood, l.trees.4_10, s.trees, species, trees)
rm(Plot.data) #if exist
...
# sum values separately for each "tree.type" ("living", "SDT" or "DDW") and plot
Plot.types <- c()
...
##########################
#ORGANIZE TO SINGLE DATA FRAME
##########################

# merge everything to new data frame
# living trees
